...
public class InitAuthSDKActivity extends Activity implements InitAuthSDKCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("InitAuthSDKActivity onCreate");

        mZoomSDK = ZoomSDK.getInstance();

        boolean isLoggedIn = mZoomSDK.isLoggedIn();
        ...
        System.out.println("InitAuthSDKActivity onCreate about to initSDK");
        InitAuthSDKHelper.getInstance().initSDK(this, this);
        System.out.println("InitAuthSDKActivity done initSDK");
        boolean isInitialized = mZoomSDK.isInitialized();
    ...
    @Override // ZoomSDKInitializeListener
    public void onZoomSDKInitializeResult(int errorCode, int internalErrorCode) {
        ...
        if (errorCode != ZoomError.ZOOM_ERROR_SUCCESS) {
            ...
            ZoomSDK.getInstance().getMeetingService().addListener(this); // onMeetingStatusChanged
            ...
            if (mZoomSDK.tryAutoLoginZoom() == ZoomApiError.ZOOM_API_ERROR_SUCCESS) {
                Log.i(TAG, "ZoomSDK::tryAutoLoginZoom got success");
    ...
    public void onClickJoin(View view) {
        ...
        Log.i(TAG, "InitAuthSDKActivity about to MeetingService::joinMeetingWithParams");
    ...
    private void showEmailLoginUserStartJoinActivity() {
        System.out.println("InitAuthSDKActivity::showEmailLoginUserStartJoinActivity");
    ...
    @Override // Triggers the joining of a meeting
    public void onMeetingStatusChanged(MeetingStatus meetingStatus, int errorCode, int internalErrorCode) {
        ...
        if (ZoomSDK.getInstance().getMeetingSettingsHelper().isCustomizedMeetingUIEnabled()) {
            if (meetingStatus == MeetingStatus.MEETING_STATUS_CONNECTING) {
                Log.i(TAG, "onMeetingStatusChanged about to showMeetingUi");
                showMeetingUi();
            }
        }
        refreshUI();
