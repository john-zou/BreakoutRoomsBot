...
import ca.ubc.cs.zoombrb.android.BreakoutRoomBot;
...
public class MeetingCommonCallback extends BaseCallback<MeetingCommonCallback.CommonEvent> {
    ...
    SimpleInMeetingListener commonListener = new SimpleInMeetingListener() {
        ...
        @Override // For Breakout Room Bot
        public void onChatMessageReceived(InMeetingChatMessage inMeetingChatMessage) {
            Log.v("BRB", "MeetingCommonCallback onChatMessageReceived");
            BreakoutRoomBot.INSTANCE.respondToChatMessage(inMeetingChatMessage);
        }
