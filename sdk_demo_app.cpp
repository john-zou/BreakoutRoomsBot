...
void CSDKDemoApp::Run(HINSTANCE hInstance)
{
	...
	m_sdk_init_auth_ui->Create(NULL, _T("Zoom SDK - Small Group Active Learning!"), UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
	m_sdk_init_auth_ui->SetIcon(IDI_ICON_LOGO);

	m_sdk_login_ui_mgr->SetEvent(this);
	m_sdk_login_ui_mgr->Create(NULL, _T("Zoom SDK - Small Group Active Learning!"), UI_WNDSTYLE_DIALOG, WS_EX_WINDOWEDGE);
