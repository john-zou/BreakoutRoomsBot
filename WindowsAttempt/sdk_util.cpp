...
{
	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::Init";
	...
	if (!_inited)
	{
		...
		BOOST_LOG_TRIVIAL(trace) << "ZOOM_SDK_NAMESPACE::InitSDK";
...
{
	BOOST_LOG_TRIVIAL(trace) << "ZOOM_SDK_NAMESPACE::GetMeetingService";
	if (_inited && NULL == _meeting_service)
	{
		...
		if (_meeting_service)
		{
			...
			// BRB
			//GetMeetingBreakoutRoomsController1();
			GetMeetingBreakoutRoomsController2();
			// /BRb
		}
	}
...
{
	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap constructor";
	_inited = false;
	_auth_service = NULL;
	_meeting_service = NULL;
	_setting_service = NULL;
	...
	//BRB initialize breakout room controllers to nullptr
	//_meeting_breakout_ctrl_1 = NULL;
	_meeting_breakout_ctrl_2 = NULL;
}
...
{
	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::ListenChatServiceMgrEvent";
...
// BRB
//void SDKInterfaceWrap::ListenBreakoutEvent1(ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsEvent* event_)
//{
//	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::ListenBreakoutEvent1";
//	_meeting_breakout_ctr_1_event_pool.AddListener(event_);
//}

void SDKInterfaceWrap::ListenBreakoutEvent2(ZOOM_SDK_NAMESPACE::IMeetingBOControllerEvent* event_)
{
	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::ListenBreakoutEvent2";
	_meeting_breakout_ctr_2_event_pool.AddListener(event_);
}

//void SDKInterfaceWrap::UnListenBreakoutEvent1(ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsEvent* event_)
//{
//	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::UnListenBreakoutEvent1";
//	_meeting_breakout_ctr_1_event_pool.RemoveListener(event_);
//}

void SDKInterfaceWrap::UnListenBreakoutEvent2(ZOOM_SDK_NAMESPACE::IMeetingBOControllerEvent* event_)
{
	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::UnListenBreakoutEvent2";
	_meeting_breakout_ctr_2_event_pool.RemoveListener(event_);
}
// /BRB
...
//	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController1";
//	if (NULL == _meeting_breakout_ctrl_1 && _inited && _meeting_service) {
//		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController1 - Attempting to GetMeetingBreakoutRoomsController() from Meeting Service.";
//		_meeting_breakout_ctrl_1 = _meeting_service->GetMeetingBreakoutRoomsController();
//		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController1 - _meeting_breakout_ctrl_1: " << _meeting_breakout_ctrl_1;
//	}
//
//	if (_meeting_breakout_ctrl_1) {
//		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController1 - _meeting_breakout_ctrl_1->SetEvent(this);";
//		_meeting_breakout_ctrl_1->SetEvent(this);
//	}
//
//	return _meeting_breakout_ctrl_1;
//}

ZOOM_SDK_NAMESPACE::IMeetingBOController* SDKInterfaceWrap::GetMeetingBreakoutRoomsController2() {
	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController2";
	if (NULL == _meeting_breakout_ctrl_2 && _inited && _meeting_service) {
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController2 - Attempting to GetMeetingBOController() from Meeting Service.";
		_meeting_breakout_ctrl_2 = _meeting_service->GetMeetingBOController();
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController2 - _meeting_breakout_ctrl_2: " << _meeting_breakout_ctrl_2;
	}

	if (_meeting_breakout_ctrl_2) {
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::GetMeetingBreakoutRoomsController2 - _meeting_breakout_ctrl_2->SetEvent(this);";
		_meeting_breakout_ctrl_2->SetEvent(this);
	}

	return _meeting_breakout_ctrl_2;
}
// /BRB
