...
class ISDKInMeetingServiceMgrEvent
		...
		// BRB
		,
			public ZOOM_SDK_NAMESPACE::IMeetingBOControllerEvent
// public ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsEvent
{
public:
	...
	// BRB
	// BRB: IMeetingBOControllerEvent // TODO
	virtual void onHasCreatorRightsNotification(ZOOM_SDK_NAMESPACE::IBOCreator *pCreatorObj) = 0;
	virtual void onHasAdminRightsNotification(ZOOM_SDK_NAMESPACE::IBOAdmin *pAdminObj) = 0;
	virtual void onHasAssistantRightsNotification(ZOOM_SDK_NAMESPACE::IBOAssistant *pAssistantObj) = 0;
	virtual void onHasAttendeeRightsNotification(ZOOM_SDK_NAMESPACE::IBOAttendee *pAttendeeObj) = 0;
	virtual void onHasDataHelperRightsNotification(ZOOM_SDK_NAMESPACE::IBOData *pDataHelperObj) = 0;
	...
	// BRB: Inherited via IMeetingBreakoutRoomsEvent
...
public:
	...
	// BRB
	//void ListenBreakoutEvent1(ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsEvent* event_);
	void ListenBreakoutEvent2(ZOOM_SDK_NAMESPACE::IMeetingBOControllerEvent *event_);

	//void UnListenBreakoutEvent1(ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsEvent* event_);
	void UnListenBreakoutEvent2(ZOOM_SDK_NAMESPACE::IMeetingBOControllerEvent *event_);
	// /BRB
	...
	// BRB Controllers for Breakout Rooms
	//ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsController* SDKInterfaceWrap::GetMeetingBreakoutRoomsController1();
	ZOOM_SDK_NAMESPACE::IMeetingBOController *SDKInterfaceWrap::GetMeetingBreakoutRoomsController2();
	// / BRB
	...
	{
		// BRB
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onChatMsgNotifcation";
		// /BRB
	...
	// BRB: IMeetingBOControllerEvent // TODO
	virtual void onHasCreatorRightsNotification(ZOOM_SDK_NAMESPACE::IBOCreator *pCreatorObj)
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onHasCreatorRightsNotification";
		BOOST_LOG_TRIVIAL(trace) << ".. pCreatorObj: " << pCreatorObj;
	}

	virtual void onHasAdminRightsNotification(ZOOM_SDK_NAMESPACE::IBOAdmin *pAdminObj)
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onHasAdminRightsNotification";
		BOOST_LOG_TRIVIAL(trace) << ".. pAdminObj: " << pAdminObj;
	}
	virtual void onHasAssistantRightsNotification(ZOOM_SDK_NAMESPACE::IBOAssistant *pAssistantObj)
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onHasAssistantRightsNotification";
		BOOST_LOG_TRIVIAL(trace) << ".. pAssistantObj: " << pAssistantObj;
	}
	virtual void onHasAttendeeRightsNotification(ZOOM_SDK_NAMESPACE::IBOAttendee *pAttendeeObj)
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onHasAttendeeRightsNotification";
		BOOST_LOG_TRIVIAL(trace) << ".. pAttendeeObj: " << pAttendeeObj;
	}
	virtual void onHasDataHelperRightsNotification(ZOOM_SDK_NAMESPACE::IBOData *pDataHelperObj)
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onHasDataHelperRightsNotification";
		BOOST_LOG_TRIVIAL(trace) << ".. pDataHelperObj: " << pDataHelperObj;
	}
	virtual void onLostCreatorRightsNotification()
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onLostCreatorRightsNotification";
	}
	virtual void onLostAdminRightsNotification()
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onLostAdminRightsNotification";
	}
	virtual void onLostAssistantRightsNotification()
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onLostAssistantRightsNotification";
	}
	virtual void onLostAttendeeRightsNotification()
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onLostAttendeeRightsNotification";
	}
	virtual void onLostDataHelperRightsNotification()
	{
		BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::onLostDataHelperRightsNotification";
	}

	// BRB: Inherited via IMeetingBreakoutRoomsEvent
	//virtual void OnBreakoutRoomsStartedNotification(const wchar_t * stBID) {
	//	BOOST_LOG_TRIVIAL(trace) << "SDKInterfaceWrap::OnBreakoutRoomsStartedNotification";
	//};
...
private:
	...
	// BRB
	//EventSinkPool<ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsEvent> _meeting_breakout_ctr_1_event_pool;
	EventSinkPool<ZOOM_SDK_NAMESPACE::IMeetingBOControllerEvent> _meeting_breakout_ctr_2_event_pool;
	// /BRB
	...
	// BRB -- breakout room controller fields
	//ZOOM_SDK_NAMESPACE::IMeetingBreakoutRoomsController* _meeting_breakout_ctrl_1;
	ZOOM_SDK_NAMESPACE::IMeetingBOController *_meeting_breakout_ctrl_2;
	// /BRB
};
